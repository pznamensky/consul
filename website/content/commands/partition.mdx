...
Configuration of [blocking queries](/api/features/blocking) and [agent caching](/api/features/caching)
...
- **Corresponding HTTP Endpoint**: [\[GET\] /v1/partition/:name](/api-docs/admin-partitions#read-a-partition)
- **Required ACLs**: `operator:write`
- **Blocking queries**: not supported from commands, but may be from the corresponding HTTP endpoint
- **Agent caching**: not supported from commands, but may be from the corresponding HTTP endpoint
...
| Detail | Info |
| ------ | ---- |
| Corresponding HTTP Endpoint | [\[GET\] /v1/partitions](/api-docs/admin-partitions#list-all-partitions) |
| Required ACLs               | `operator:write` |
| [Blocking queries]((/api/features/blocking)) | not supported from commands, but may be from the corresponding HTTP endpoint |
| [Agent caching](/api/features/caching) | not supported from commands, but may be from the corresponding HTTP endpoint |
